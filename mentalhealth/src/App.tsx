...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxPGxx0YwW9Gb4KmwagkD8Iu1v40GPcW375wV9lEKXE-JiLTDWFbJEKdqdTT1BP_2RX/exec"; // ใช้ Proxy Path ที่ตั้งใน vite.config.ts
