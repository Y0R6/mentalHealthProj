...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbxQRHw-G5EOr5NAd19e--P4UUPR72fqGgEdvM_AFGPNE21nqkzTS9OxCCcaWW1CRxOA/exec"; // ใช้ Proxy Path ที่ตั้งใน vite.config.ts
