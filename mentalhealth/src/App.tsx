...
const GAS_WEB_APP_URL = "https://script.google.com/macros/s/AKfycbwKQMg7MNZlWLOWFFHQnrHNqIjymTvsKgIqLPSWujmsf7A9rr4vs-Q2CsvfQvgbXlVtyQ/exec"; // ใช้ Proxy Path ที่ตั้งใน vite.config.ts
